...
extern void *mono_aot_module_Lukbuk_iOS_info;
...
extern void *mono_aot_module_Flurl_Http_info;
extern void *mono_aot_module_Flurl_info;
...
{
	mono_aot_register_module (mono_aot_module_Lukbuk_iOS_info);
	...
	mono_aot_register_module (mono_aot_module_Flurl_Http_info);
	mono_aot_register_module (mono_aot_module_Flurl_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "Lukbuk.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 2;
